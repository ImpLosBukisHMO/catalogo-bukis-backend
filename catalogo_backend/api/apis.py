...
class APIIniciarSesion(views.APIView):
    ...
    def post(self, request):
        ...
        res.set_cookie(key='access_token', value=str(refresh.access_token), httponly=True, **cookie_security_kwargs())
        res.set_cookie(key='refresh_token', value=str(refresh), httponly=True, **cookie_security_kwargs())
...
class APICerrarSesion(views.APIView):
    ...
    def post(self, request):
        ...
        res.set_cookie(key='access_token', value='', max_age=0, path='/', httponly=True, **cookie_security_kwargs())
        res.set_cookie(key='refresh_token', value='', max_age=0, path='/', httponly=True, **cookie_security_kwargs())
        res.set_cookie(key='jwt', value='', max_age=0, path='/', httponly=True, **cookie_security_kwargs())
        samesite_kwarg = cookie_security_kwargs().get('samesite', 'Lax')
...
class CustomTokenObtainPairView(TokenObtainPairView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if res.status_code == 200:
            ...
            res.set_cookie(key='access_token', value=access_token, httponly=True, **cookie_security_kwargs())
            res.set_cookie(key='refresh_token', value=refresh_token, httponly=True, **cookie_security_kwargs())
    ...
    def post(self, request, *args, **kwargs):
        ...
        if res.status_code == 200:
            ...
            if 'refresh' in res.data:
                res.set_cookie(key='refresh_token', value=res.data['refresh'], httponly=True, **cookie_security_kwargs())
        return res